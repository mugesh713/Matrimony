...
export default function Home() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', 'Segoe UI', system-ui, sans-serif", color: '#2d3748', backgroundColor: '#f8fafc', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <header style={{ backgroundColor: '#2d1810', color: '#e2e8f0', padding: '8px 40px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '13px', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
      ...
      <section style={{ position: 'relative', minHeight: '520px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', color: '#fff', textAlign: 'center', padding: '40px 20px', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 10, width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          <div style={{ backgroundColor: 'rgba(212, 175, 55, 0.15)', border: '1px solid rgba(212, 175, 55, 0.4)', borderRadius: '30px', padding: '6px 18px', marginBottom: '16px' }}>
            <p style={{ color: '#f59e0b', fontWeight: '700', fontSize: '13px', letterSpacing: '1.5px', margin: 0, textTransform: 'uppercase' }}>#1 KONGU MATRIMONY PLATFORM</p>
          </div>

          <h1 style={{ fontSize: '48px', fontWeight: '800', margin: '0 0 12px 0', fontFamily: 'Georgia, serif' }}>
            Find Your <span style={{ color: '#ef4444', textDecoration: 'underline decoration-wavy 2px' }}>Right Match</span> Here
          </h1>
          <p style={{ fontSize: '18px', color: '#cbd5e1', marginBottom: '40px', maxWidth: '600px', fontWeight: '300' }}>
            Most trusted Kongu Vellalar Gounder's Matrimony connecting souls worldwide.
          </p>

          <form onSubmit={handleSearch} style={{ backgroundColor: 'rgba(15, 23, 42, 0.75)', backdropFilter: 'blur(12px)', border: '1px solid rgba(255, 255, 255, 0.15)', padding: '20px', borderRadius: '12px', display: 'flex', gap: '12px', flexWrap: 'wrap', maxWidth: '1050px', width: '100%', alignItems: 'center', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.5)' }}>
      ...
      {/* 3. OUR SERVICES */}
      <section style={{ backgroundColor: '#0f172a', color: '#fff', padding: '70px 20px', textAlign: 'center' }}>
        <p style={{ color: '#f59e0b', textTransform: 'uppercase', letterSpacing: '2px', fontSize: '12px', fontWeight: '700', margin: 0 }}>EXPLORE FEATURES</p>
        <h2 style={{ fontSize: '36px', fontFamily: 'Georgia, serif', margin: '8px 0 45px 0', color: '#fbbf24' }}>Our Services 🌿</h2>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(230px, 1fr))', gap: '24px', maxWidth: '1100px', margin: '0 auto' }}>
          {[
      ...
      {/* 4. TESTIMONIALS */}
      <section style={{ backgroundColor: '#ffffff', padding: '70px 20px', textAlign: 'center' }}>
        <p style={{ color: '#991b1b', fontWeight: '700', letterSpacing: '1px', fontSize: '13px', margin: 0, textTransform: 'uppercase' }}>TESTIMONIALS</p>
        <h2 style={{ fontSize: '36px', color: '#0f172a', margin: '8px 0 45px 0', fontWeight: '700' }}>
          Trusted by <span style={{ color: '#991b1b' }}>1500+</span> Happy Couples
        </h2>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(290px, 1fr))', gap: '24px', maxWidth: '1050px', margin: '0 auto' }}>
          {[
            ...
            <div key={idx} style={{ border: '1px solid #e2e8f0', padding: '28px', borderRadius: '12px', backgroundColor: '#f8fafc', textAlign: 'left', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.05)' }}>
              <p style={{ fontSize: '15px', color: '#475569', lineHeight: '1.7', fontStyle: 'italic', margin: 0 }}>"{text}"</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* 5. WHY CHOOSE US */}
      <section style={{ backgroundColor: '#334155', color: '#fff', padding: '70px 20px', textAlign: 'center' }}>
        <p style={{ color: '#fbbf24', fontWeight: '700', margin: 0, fontSize: '13px', letterSpacing: '1px' }}>#1 KONGU VELLALAR GOUNDER'S MATRIMONY</p>
        <h2 style={{ fontSize: '36px', margin: '8px 0 12px 0', fontWeight: '700' }}>Why Choose Us</h2>
        <p style={{ color: '#cbd5e1', marginBottom: '45px', fontSize: '15px' }}>Most trusted and authentic matchmaking platform.</p>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '24px', maxWidth: '1050px', margin: '0 auto' }}>
          {[
            ...
            <div key={idx} style={{ backgroundColor: '#ffffff', color: '#1e293b', padding: '32px 24px', borderRadius: '12px', boxShadow: '0 10px 15px -3px rgba(0,0,0,0.1)' }}>
      ...
      <section style={{ padding: '90px 20px', maxWidth: '1150px', margin: '0 auto', display: 'flex', gap: '50px', alignItems: 'center', flexWrap: 'wrap', position: 'relative' }}>
        <div style={{ flex: 1, minWidth: '320px', position: 'relative' }}>
          ...
          <div style={{ position: 'absolute', bottom: '-20px', right: '-10px', zIndex: 3, backgroundColor: 'rgba(255, 255, 255, 0.95)', backdropFilter: 'blur(10px)', border: '1px solid #f1f5f9', borderRadius: '12px', padding: '16px 24px', boxShadow: '0 10px 25px -5px rgba(0,0,0,0.1)', display: 'flex', alignItems: 'center', gap: '12px' }}>
            <span style={{ fontSize: '24px' }}>💍</span>
            <div>
              <p style={{ margin: 0, fontWeight: '800', fontSize: '16px', color: '#0f172a' }}>100% Genuine</p>
              <p style={{ margin: 0, fontSize: '12px', color: '#64748b' }}>Verified Kongu Profiles</p>
            </div>
          </div>
        </div>

        <div style={{ flex: 1.2, minWidth: '320px' }}>
          <span style={{ backgroundColor: '#fee2e2', color: '#dc2626', padding: '6px 14px', borderRadius: '20px', fontSize: '12px', fontWeight: '700', letterSpacing: '1px', textTransform: 'uppercase' }}>ABOUT PLATFORM</span>
          <h2 style={{ fontSize: '38px', color: '#0f172a', margin: '16px 0', lineHeight: '1.2', fontWeight: '800', fontFamily: 'Georgia, serif' }}>
            WELCOME TO <br />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
            <div style={{ border: '1px solid #e2e8f0', padding: '18px', borderRadius: '12px', backgroundColor: '#fff', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.02)' }}>
              <p style={{ margin: 0, fontSize: '12px', color: '#94a3b8', textTransform: 'uppercase', fontWeight: '700' }}>Enquiry</p>
              <p style={{ margin: '6px 0 0 0', fontWeight: '800', color: '#0f172a', fontSize: '16px' }}>+91 94455 55941</p>
            </div>
            <div style={{ border: '1px solid #e2e8f0', padding: '18px', borderRadius: '12px', backgroundColor: '#fff', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.02)' }}>
              <p style={{ margin: 0, fontSize: '12px', color: '#94a3b8', textTransform: 'uppercase', fontWeight: '700' }}>Get Support</p>
              <p style={{ margin: '6px 0 0 0', fontWeight: '800', color: '#0f172a', fontSize: '16px' }}>help@varam.app</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ backgroundColor: '#f8fafc', padding: '80px 20px', textAlign: 'center', borderTop: '1px solid #e2e8f0' }}>
        <p style={{ color: '#991b1b', fontWeight: '800', letterSpacing: '1.5px', fontSize: '13px', margin: 0, textTransform: 'uppercase' }}>
          OUR PROFESSIONALS
        </p>
        <h2 style={{ fontSize: '36px', color: '#0f172a', margin: '8px 0 50px 0', fontWeight: '800', fontFamily: 'Georgia, serif' }}>Meet Our Team</h2>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(190px, 1fr))', gap: '24px', maxWidth: '1100px', margin: '0 auto' }}>
          {[
            ...
            <div key={idx} className="team-card" style={{ borderRadius: '16px', overflow: 'hidden', backgroundColor: '#fff' }}>
              ...
              <div style={{ padding: '16px 12px' }}>
                <p style={{ margin: 0, fontSize: '15px', fontWeight: '700', color: '#0f172a' }}>{member.name}</p>
...
<footer style={{ backgroundColor: '#0b0f19', color: '#94a3b8', borderTop: '1px solid #1e293b', padding: '70px 20px 30px 20px', position: 'relative' }}>
  <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '40px', textAlign: 'left' }}>
    
    {/* Column 1: Brand & Socials */}
    <div>
      <h3 style={{ color: '#fff', fontSize: '20px', fontWeight: '800', marginBottom: '16px', fontFamily: 'Georgia, serif' }}>VARAM.APP</h3>
      ...
      <div style={{ display: 'flex', gap: '12px' }}>
        {['f', '▶', '📸', '💬'].map((icon, i) => (
          <button key={i} className="social-btn" style={{ backgroundColor: '#1e293b', color: '#fff', border: 'none', width: '38px', height: '38px', borderRadius: '50%', cursor: 'pointer', fontSize: '14px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            {icon}
          </button>
        ))}
      </div>
    ...
    {/* Column 2: Get In Touch (Stacked Vertically) */}
    <div>
      <h4 style={{ color: '#f8fafc', marginBottom: '20px', fontSize: '15px', fontWeight: '700', letterSpacing: '0.5px' }}>GET IN TOUCH</h4>
      <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
        <li className="footer-link" style={{ fontSize: '14px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px' }}>
    ...
    {/* Column 3: Help & Support (Stacked Vertically) */}
    <div>
      <h4 style={{ color: '#f8fafc', marginBottom: '20px', fontSize: '15px', fontWeight: '700', letterSpacing: '0.5px' }}>HELP & SUPPORT</h4>
      <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
        <li className="footer-link" style={{ fontSize: '14px', cursor: 'pointer' }}>About Company</li>
        <li className="footer-link" style={{ fontSize: '14px', cursor: 'pointer' }}>Privacy Policy</li>
        <li className="footer-link" style={{ fontSize: '14px', cursor: 'pointer' }}>Contact Us</li>
        <li className="footer-link" style={{ fontSize: '14px', cursor: 'pointer' }}>FAQs</li>
      </ul>
    </div>
  ...
  {/* Footer Bottom Bar */}
  <div style={{ borderTop: '1px solid #1e293b', marginTop: '50px', paddingTop: '30px', textAlign: 'center', fontSize: '14px', color: '#64748b', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', maxWidth: '1100px', margin: '50px auto 0 auto', gap: '16px' }}>
    <p style={{ margin: 0 }}>Copyright © 2026 varam.app | All rights reserved.</p>
    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
      <span>Ready to find your match?</span>
      <button onClick={() => navigate('/register')} style={{ backgroundColor: '#dc2626', color: '#fff', border: 'none', padding: '10px 20px', borderRadius: '6px', cursor: 'pointer', fontWeight: '600' }}>
        Join Us Today
      </button>
    </div>
  </div>
